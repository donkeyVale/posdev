              ...
              echo '<tr>
                      ...
                      <td>
                        ...
                        if($_SESSION["perfil"] == "Administrador"){
                            echo '<button class="btn btn-danger btnEliminarProducto" idProducto="'.$value["id"].'"><i class="fa fa-times"></i></button>';
                        }

                            if($_SESSION["perfil"] == "Administrador"){
                                echo '<button class="btn btn-success btnAgregaProductorHijo" idProducto="'.$value["id"].'"><i class="fa fa-building"></i></button>';
                            }
                        echo '</div>  
                      </td>
                    </tr>';
...
<!--              </div>-->
              <div class="col-xs-12">
                <div class="input-group">
                  <span class="input-group-addon"><i class="fa fa-calendar"></i></span> 
                  <input type="date" class="form-control input-lg" name="editarFechaVencimiento" id="editarFechaVencimiento" placeholder="Fecha Vencimiento">
                </div>
              </div>
            </div>
