<div class="content-wrapper">
  <section class="content-header">
    <h1>Aprobar Transferencia</h1>
    <ol class="breadcrumb">
      <li><a href="#"><i class="fa fa-dashboard"></i> Inicio</a></li>
      <li class="active">Aprobar Transferencia</li>
    </ol>
  </section>
    ...
    <div class="row">
      ...
      <div class="col-md-12 col-xs-12">
        <div class="box box-success">
          ...
          <form role="form" method="post" class="formularioAprobacionTransferencia">
            <div class="box-body">
              <div class="box">
                <?php
                    $item = "id";
          ...
          <div class="box-footer">
            ...
            <button type="submit" id="btnGuardarAprobacion" name="btnGuardarAprobacion" class="btn btn-success pull-right">Aprobar Transferencia</button>
          </div>
          <?php
              $aprobarTransferencia = new ControladorTransferencias();
              $aprobarTransferencia -> ctrAprobarTransferencia();
              ?>
        </form>
        </div>  
      </div>
