<div class="content-wrapper">
  <section class="content-header">
    <h1>Recepcionar Transferencia</h1>
    <ol class="breadcrumb">
      <li><a href="#"><i class="fa fa-dashboard"></i> Inicio</a></li>
      <li class="active">Recepcionar Transferencia</li>
    </ol>
  </section>
    ...
    <div class="row">
      ...
      <div class="col-md-12 col-xs-12">
        <div class="box box-success">
          ...
          <form role="form" method="post" class="formularioRecepcionarTransferencia">
            <div class="box-body">
              <div class="box">
                <?php
                    $item = "id";
                  ...
                  <div class="form-group">
                    <div class="col-md-4">
                      <div class="input-group">
                        ...
                        <input type="text" class="form-control" id="codigoTransferencia" name="codigoTransferencia" value="<?php echo $transferencia["id"]; ?>" readonly>
                      </div>
                    </div>
                    <div class="col-md-4">
                      <div class="input-group">
          ...
          <div class="box-footer">
            ...
            <button type="submit" id="btnGuardarRecepcion" name="btnGuardarRecepcion" class="btn btn-success pull-right">Recepcionar Transferencia</button>
          </div>
          <?php
              $recepcionarTransferencia = new ControladorTransferencias();
              $recepcionarTransferencia -> ctrRecepcionarTransferencia();
              ?>
        </form>
        </div>  
      </div>
