      ...
      <form role="form" method="post">
        ...
        <div class="modal-body">
          <div class="box-body">
            ...
            <!-- ENTRADA PARA EL GRUPO DE CLIENTES -->
            <div class="form-group">
              <div class="input-group">
                <span class="input-group-addon"><i class="fa fa-id-card-o"></i></span> 
                <select name="selectGrupoCliente" class="form-control input-lg">
                  <?php
                      $item = null;
                      $valor = null;
                      $grupos = ControladorClientes::ctrMostrarGruposClientes();
            ...
            <div class="form-group">
              <div class="input-group">
                ...
                <input type="number" step="0.01" class="form-control input-lg" name="nuevoLimite" placeholder="Límite de Crédito">
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="modal-body">
          <div class="box-body">
            ...
            <div class="form-group">
              <div class="input-group">
                <span class="input-group-addon"><i class="fa fa-key"></i></span> 
                <input type="text" min="0" class="form-control input-lg" name="editarDocumentoId" id="editarDocumentoId" onKeyPress="if(this.value.length==11) return false;" required>
              </div>
            </div>
            <!-- ENTRADA PARA EL EMAIL -->
            <div class="form-group">
            ...
            <div class="form-group">
              <div class="input-group">
                <span class="input-group-addon"><i class="fa fa-id-card-o"></i></span> 
                <select name="editarGrupoCliente" id="editarGrupoCliente" class="form-control input-lg">
                  <?php
                      $item = null;
                      $valor = null;
                      $grupos = ControladorClientes::ctrMostrarGruposClientes();
            ...
            <div class="form-group">
              <div class="input-group">
                <span class="input-group-addon"><i class="fa fa-calculator"></i></span> 
                <input type="number" class="form-control input-lg" name="editarLimite" id="editarLimite" placeholder="Límite de Crédito" >
              </div>
            </div>
          </div>
        </div>
