            ...
            <div class="box-body">
              <div class="box">
                <?php
                    ...
                    $venta = ControladorVentas::ctrMostrarCabeceraVentas($valor);
                    //$itemUsuario = "id";
                ...
                <div class="row">
                  <div class="form-group">
                    ...
                    <div class="col-md-6">
                      <div class="input-group">
                        <label for="metodo">Código Venta</label>
                        <input type="text" class="form-control" id="metodo" value="<?php echo $venta["codigo"]; ?>" readonly>
                      </div>
                    </div>
                  </div>
                </div>
