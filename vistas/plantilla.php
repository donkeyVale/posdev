   ...
   echo '<div class="wrapper">';
    ...
    if(isset($_GET["ruta"])){
      ...
      if($_GET["ruta"] == "inicio" ||
         ...
         $_GET["ruta"] == "marcas" ||
         $_GET["ruta"] == "unidades" ||
         $_GET["ruta"] == "gruposcliente" || 
         $_GET["ruta"] == "terminos-pago" || 
         $_GET["ruta"] == "cajas" || 
         ...
         $_GET["ruta"] == "calces" || 
         $_GET["ruta"] == "compras" ||
         $_GET["ruta"] == "ver-compra" ||
         $_GET["ruta"] == "crear-compra" ||
         $_GET["ruta"] == "crear-producto" ||
         $_GET["ruta"] == "asignar-depositos-usuario" ||
         $_GET["ruta"] == "crear-transferencia" ||
...
<script src="vistas/js/gruposclientes.js"></script>
<script src="vistas/js/terminospago.js"></script>
<script src="vistas/js/cajas.js"></script>
<script src="vistas/js/proveedores.js"></script>
<script src="vistas/js/sucursales.js"></script>
<script src="vistas/js/aperturas.js"></script>
<script src="vistas/js/categoriagastos.js"></script>
<script src="vistas/js/depositos.js"></script>
<script src="vistas/js/colores.js"></script>
<script src="vistas/js/calces.js"></script>
