    ...
    $.ajax({
        ...
        success: function(respuesta) {
            ...
            $(".nuevoProducto").append(
                    ...
                    '<div class="input-group">' +
                    '<input type="text" class="form-control subTotalPrecioProducto" precioReal="' + precio + '" name="subTotalPrecioProducto" value="' + precio + '" readonly required>' +
                    '</div>' +
                    '</div>' +
                    //'<div class="col-xs-3">' +
                    //'<div class="input-group">' +
                    //'<span class="input-group-addon"><i class="fa fa-percent"></i></span>' +
                    //' <input type="number" class="form-control nuevoDescuento" name="nuevoDescuento" id="nuevoDescuento" min="0" value="0" required>' +
                    //'</div>' +
                    //'</div>' +
                    //'<!-- Descuento del producto -->' +
                    //'<div class="col-xs-3">' +
                    //'Monto Descuento<input type="number" class="form-control montoDescuento" name="montoDescuento" id="montoDescuento" min="0" value="0" required>' +
                    //'</div>' +
                    '</div>')
...
$("#nuevoMetodoPago").change(function() {
    ...
    if (metodo == "EFECTIVO") {
        ...
        $.ajax({
            type: 'POST',
            url: "ajax/datatable-general.ajax.php",
            dataType: "json",
            success: function(respuesta) {
                ...
                $('.cajasMetodoPago').html(
                    ...
                    '<div class="input-group">' +
                    '<input type="number" min="1"  max="' + datos + '" class="form-control" id="cuotas" name="cuotas" placeholder="' + 'Numero Maximo de Cuotas: ' + datos + '" required>' +
        ...
        $(this).parent().parent().parent().children('.cajasMetodoPago').html(
            '<div class="col-xs-6" style="padding-left:0px">' +
            '<div class="input-group">' +
            '<input type="number" min="0" max="9999" class="form-control" id="nuevoCodigoTransaccion" name="nuevoCodigoTransaccion" placeholder="Código transacción" maxlength="4"  required>' +
            '<span class="input-group-addon"><i class="fa fa-lock"></i></span>' +
            '</div>' +
            '</div>')
    }
...
$("#btnGuardar").click(function(e) {
    ...
    if ($valor == "0") {
        ...
        $valor = $("#nuevoMetodoPago").val();
        if ($valor == "0") {
            e.preventDefault();
            swal({
                type: "error",
                title: "Tiene que seleccionar un método de pago",
                showConfirmButton: true,
                confirmButtonText: "Cerrar"
            }).then(function(result) {});
        } else {
